                  ...
                  <div class="modal-body">
                    <form>
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control @error('tipo') is-invalid @else border-0 @enderror" id="tipo" name="tipo" placeholder="Seleccionar">
                        ...
                        <option value="accesorios" {{ old('tipo') == 'accesorios' ? 'selected' : ''}}>Accesorios</option>
                         ...
                         <option value="juguetes" {{ old('tipo') == 'juguetes' ? 'selected' : ''}}>Juguetes</option>                        
